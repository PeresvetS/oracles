...
/** Инструкция Директору в начале DISCUSSION раунда (перед ходом аналитиков) */
export const DISCUSSION_DIRECTOR_TASK_INSTRUCTION = [
  'Сформулируй краткое и конкретное задание аналитикам на этот раунд.',
  'Опирайся на вводные пользователя и текущий пул идей.',
  'Если режим сессии VALIDATE — работай только с existingIdeas, без генерации нового списка идей.',
  'Не предлагай новые идеи от себя и не вызывай call_researcher на этом шаге.',
  'Ответ в формате: цель раунда + 3-5 пунктов, что проверить аналитикам.',
].join('\n');
