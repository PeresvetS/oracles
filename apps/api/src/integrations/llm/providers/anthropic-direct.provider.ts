...
const NOT_IMPLEMENTED_MESSAGE = `Провайдер ${PROVIDER_NAME} не реализован. Используйте OpenRouter для доступа к моделям Anthropic.`;

/**
 * Заглушка для прямого Anthropic API.
